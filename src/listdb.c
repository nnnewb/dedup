...
int listdb_set(LISTDB *db, uint64_t index, void *value) { return listdb_value(db, index, value, VALUE_SET); }

int listdb_get(LISTDB *db, uint64_t index, void *value) { return listdb_value(db, index, value, VALUE_GET); }
