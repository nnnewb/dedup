 ...
 */
void md5_hmac_update(md5_context *ctx, unsigned char *input, int ilen) { md5_update(ctx, input, ilen); }
...
#if MD5_TEST
static void md5_2_str(unsigned char md5_checksum[16], char *md5_str) {
