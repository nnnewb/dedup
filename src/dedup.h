...
enum DEDUP_OPERATIONS { DEDUP_CREAT = 0, DEDUP_EXTRACT, DEDUP_APPEND, DEDUP_REMOVE, DEDUP_LIST, DEDUP_STAT };
...
enum DEDUP_CHUNK_ALGORITHMS { DEDUP_CHUNK_FSP = 0, DEDUP_CHUNK_CDC, DEDUP_CHUNK_SB };
